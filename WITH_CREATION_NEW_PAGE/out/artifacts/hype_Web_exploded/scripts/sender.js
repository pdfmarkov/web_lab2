// С РАЗДЕЛЬНЫМИ СТРАНИЦАМИ НЕ РАБОТАЕТ

function sendRequest(x,y,r,flag) {
    $.ajax({
        method: "GET",
        url: "/offline_war_exploded/controller?coordinateX=" + x + "&coordinateY="
            + y + "&radius=" + r + "&flag=" + flag,
    })
    .done(function (cell) {
        //location.href = "/offline_war_exploded/controller?coordinateX=" + x + "&coordinateY=" + y + "&radius=" + r + "&flag=" + flag;
